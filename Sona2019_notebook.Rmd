...
```
The above chart shows one clear outlier with the category <i>trust</i> totalling at 6628 which is 1.6 times larger than the second highest category <i>anticipation</i>. Moreover, <i>trust</i> more than doubles the total of the closest negative category <i>fear</i>. To find out why this is the case, let's explore the words that makeup each sentiment score using the Wordcloud package.
```{r}
